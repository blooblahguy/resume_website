<?
	...
	define( 'SMTP_HOST', 'smtp.gmail.com' );  // A2 Hosting server name. For example, "server.a2hosting.com"
	define( 'SMTP_AUTH', true );
	define( 'SMTP_PORT', '465' );
	define( 'SMTP_SECURE', 'ssl' );
	define( 'SMTP_USERNAME', 'gladelynch@gmail.com' );  // Username for SMTP authentication
	define( 'SMTP_PASSWORD', 'gladel!23' );          // Password for SMTP authentication
	define( 'SMTP_FROM',     'gladelynch@gmail.com' );  // SMTP From address
	define( 'SMTP_FROMNAME', 'Glade Lynch' );         // SMTP From name
